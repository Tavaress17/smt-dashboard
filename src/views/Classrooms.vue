    ...
    <div v-if="showModal" class="modal-overlay" @click="closeModal">
      <div class="modal-content" @click.stop>
        ...
        <form @submit.prevent="handleSubmit" class="modal-form">
          ...
          <div class="input-group">
            <label for="block" class="input-label">Bloco *</label>
            <input
              id="block"
          ...
          <div class="input-group">
            <label for="floor" class="input-label">Andar *</label>
            <input
              id="floor"
          ...
          <div class="input-group">
            <label for="capacity" class="input-label">Capacidade *</label>
            <input
              id="capacity"
          ...
          <div class="input-group">
            <label for="observation" class="input-label">Observação</label>
            <input
              id="observation"
    ...
    <div v-if="showDeleteModal" class="modal-overlay" @click="closeDeleteModal">
      <div class="modal-content modal-small" @click.stop>
        ...
        <p class="modal-text">
          ...
          <strong>{{ selectedClassroom?.description }}</strong>?
...
const loadClassrooms = async () => {
  ...
  try {
    ...
    error.value = err.message || 'Erro ao carregar salas';
  } finally {
    loading.value = false;
  }
};
...
const openEditModal = (classroom: Classroom) => {
    ...
    formData.block = classroom.block;
    formData.floor = classroom.floor;
    formData.capacity = String(classroom.capacity);
    formData.observation = classroom.observation;
    showModal.value = true;
};
...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (isEditing.value) {
      await classroomsService.update(formData.id, data);
    } else {
    ...
    formError.value = err.message || 'Erro ao salvar sala';
  } finally {
    saving.value = false;
  }
};
...
const handleDelete = async () => {
  ...
  try {
    await classroomsService.delete(selectedClassroom.value.id);
    await loadClassrooms();
    closeDeleteModal();
  } catch (err: any) {
