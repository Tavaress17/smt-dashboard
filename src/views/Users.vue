        ...
        <tbody>
          <tr v-for="user in users" :key="user.id">
            ...
            <td>
              <span 
                class="badge" 
                :class="user.authoritiesList.includes('ROLE_ADMIN_USER') ? 'badge-admin' : 'badge-user'"
              >
                {{ user.authoritiesList.includes('ROLE_ADMIN_USER') ? 'Admin' : 'Usuário' }}
              </span>
            </td>
            <td>
    ...
    <div v-if="showModal" class="modal-overlay" @click="closeModal">
      <div class="modal-content" @click.stop>
        ...
        <form @submit.prevent="handleSubmit" class="modal-form">
          ...
          <div class="input-group">
            <label for="enrollment" class="input-label">Matrícula *</label>
            <input
              id="enrollment"
...
const openEditModal = (user: User) => {
  ...
  formData.enrollment = user.enrollment;
  formData.isAdmin = user.authoritiesList.includes('ROLE_ADMIN_USER');
  showModal.value = true;
};
...
const handleSubmit = async () => {
  ...
  try {
    ...
    if (isEditing.value) {
      await usersService.update(formData.id, data);
    } else {
